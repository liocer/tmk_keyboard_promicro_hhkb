...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
     ...
     * |Pwr| F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|Ins|Del|
     * |-----------------------------------------------------------|
     * |     |Prv|Mpy|Nxt|   |   |   |PgU|Up |PgD|   |   |   |Backs|
     * |-----------------------------------------------------------|
     * |      |   |VoD|VoU|   |   |Hom|Lef|Dow|Rig|   |   |Enter   |
     * |-----------------------------------------------------------|
     * |        |   |   |   |   |   |End|   |   |   |   |      |   |
     * `-----------------------------------------------------------'
     *       |   |     |                       |     |   |
     ...
     */
    KEYMAP(PWR, F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9,  F10, F11, F12, INS, DEL,   \
           TRNS,MPRV,MPLY,MNXT,TRNS,TRNS,TRNS,PGUP, UP ,PGDN,TRNS,TRNS, TRNS, BSPC,     \
           TRNS,TRNS,VOLD,VOLU,TRNS,TRNS,HOME,LEFT,DOWN,RGHT,TRNS,TRNS,TRNS,            \
           TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,END ,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,            \
                TRNS,TRNS,          TRNS,               TRNS,TRNS),
...
const uint16_t fn_actions[] __attribute__ ((section (".keymap.fn_actions"))) = {
    ...
    [1]  = ACTION_LAYER_TAP_KEY(2, KC_TAB),
